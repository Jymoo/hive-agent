...
const (
	...
	ToolGetPVCs            = "get_pvcs"
	ToolGetJobs            = "get_jobs"
	ToolGetCronJobs        = "get_cronjobs"
)
...
func KubernetesToolDefinitions() []ToolDefinition {
	return []ToolDefinition{
		...
		tool(ToolGetPVCs, "List PersistentVolumeClaims in a namespace or across all namespaces.", namespaceParams()),
		tool(ToolGetJobs, "List Jobs in a namespace or across all namespaces.", namespaceParams()),
		tool(ToolGetCronJobs, "List CronJobs in a namespace or across all namespaces.", namespaceParams()),
	}
}
